...
def test_end_to_end_from_smiles(tmp_path):
...
def test_end_to_end_from_sdf_reads_the_charge(tmp_path):
    result = build_ligand_xml(
...
def test_explicit_charge_contradicting_the_molecule_is_refused(tmp_path):
...
def test_mixed_backends_produce_one_loadable_xml(tmp_path):
